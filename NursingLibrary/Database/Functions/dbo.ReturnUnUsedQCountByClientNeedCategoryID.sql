...
PRINT 'Creating Function ReturnUnUsedQCountByClientNeedCategoryID'
GO 
...
BEGIN 
/*============================================================================================================                
 -- Purpose: Retrieves UnUsedQCountByClientNeedCategoryID(Qbank) based on ProgramofStudyId
...
SELECT  @Result=count(*)
 ...
 dbo.TestQuestions ON dbo.Tests.TestID = dbo.TestQuestions.TestID 
...
END 
GO
PRINT 'Finished creating Function ReturnUnUsedQCountByClientNeedCategoryID'
GO 
