IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[uspGetQuestionsByUserTest]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [dbo].[uspGetQuestionsByUserTest]
GO

/****** Object:  StoredProcedure [dbo].[uspGetQuestionsByUserTest]    Script Date: 10/10/2011 15:49:07 ******/
SET ANSI_NULLS ON
GO
