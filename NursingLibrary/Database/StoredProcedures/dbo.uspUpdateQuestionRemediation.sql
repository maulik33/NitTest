IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[uspUpdateQuestionRemediation]') AND type in (N'P', N'PC'))
    DROP PROCEDURE [dbo].[uspUpdateQuestionRemediation]
GO

/****** Object:  StoredProcedure [dbo].[uspUpdateQuestionRemediation]    Script Date: 10/10/2011 15:49:07 ******/
SET ANSI_NULLS ON
GO
