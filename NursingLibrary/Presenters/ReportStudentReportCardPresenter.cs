...
{
    [Presenter]
    public class ReportStudentReportCardPresenter : ReportPresenterBase<IReportStudentReportCardView>
    {
        #region Fields
        ...
        #region Constructor
        public ReportStudentReportCardPresenter(IReportDataService service)
            : base(Module.Reports)
        {
        ...
        {
            IEnumerable<StudentReportCardDetails> reportData = _reportDataService.GetStudentReportCardDetails(
                Parameters[ReportParamConstants.PARAM_STUDENT].SelectedValues,
