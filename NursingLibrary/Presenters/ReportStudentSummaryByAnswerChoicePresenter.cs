...
{
    [Presenter]
    public class ReportStudentSummaryByAnswerChoicePresenter : ReportPresenterBase<IReportStudentSummaryByAnswerChoiceView>
    {
        ...
        public ReportStudentSummaryByAnswerChoicePresenter(IReportDataService service)
            : base(Module.Reports)
        {
        ...
        {
            DataTable reportData = TransferTable(_reportDataService.GetResultsForStudentSummaryByAnswerChoice(
                Parameters[ReportParamConstants.PARAM_COHORT].SelectedValues,
                Parameters[ReportParamConstants.PARAM_TESTTYPE].SelectedValues.ToInt(),
