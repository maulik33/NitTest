<%@ Page Language="C#" MasterPageFile="~/ADMIN/ReportMaster.master" AutoEventWireup="true"
    Inherits="ADMIN_ReportStudentReportCard" Title="Student Report Card" CodeBehind="ReportStudentReportCard.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function Validate() {
            ...
            if (lbxProducts != null && (lbxProducts.options.selectedIndex == 0)) {
