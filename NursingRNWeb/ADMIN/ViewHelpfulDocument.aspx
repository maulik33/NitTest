<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeBehind="ViewHelpfulDocument.aspx.cs" EnableViewState="false" Inherits="NursingRNWeb.ADMIN.ViewHelpfulDocument" %>
        ...
        <tr>
            <td>
                <table align="left" border="0" class="formtable">
                    ...
                    <tr class="datatable2">
                        <td style="vertical-align: top">
                            <asp:Label ID="lblUploadedDate" runat="server" Text=""></asp:Label>
                        </td>
                        <td align="left" class="datatable">
                    ...
                    <tr class="datatable2">
                        <td style="vertical-align: top">
                            <asp:Label ID="lblUploadedUser" runat="server" Text=""></asp:Label>
                        </td>
                        <td align="left" class="datatable">
