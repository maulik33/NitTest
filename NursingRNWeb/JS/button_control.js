...
//		document.NextAction.value = "1"
		...
		document.getElementById('next').innerHTML = '<a href="javascript:submitNext();"><img src="/kaptoefl/images/next.gif" class="button" alt="" width="75" height="25" onmouseover="roll(this)" onmouseout="roll(this)" /></a>';
	}
	else {
		//Open layer
...
function setConfirm(state){
	...
	if(state == "off"){
		var bString = '<img src="/kaptoefl/images/confirm_off.gif" class="button" alt="" width="75" height="25" />'
	} else {
		var bString = '<a href="javascript:setNext();"><img src="/kaptoefl/images/confirm.gif" class="button" alt="" width="75" height="25" onmouseover="roll(this)" onmouseout="roll(this)" /></a>';
	}
