...
public partial class ValidateNursing : PageBase<IValidateNursingView, ValidateNursingPresenter>, IValidateNursingView
{
    ...
    public ValidateNursingParams GetQueryParameters()
    {
        ...
        TraceHelper.Create(_traceToken, "Validate Nursing Get Query Parameters")
